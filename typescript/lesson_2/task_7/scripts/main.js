...
function User1(id, name, surname, email, phone) {
    this.id = id;
    this.name = name;
...
function makeUsersObj(users) {
    for (var i = 1; i <= 10; i++) {
        users.push(new User1(i, "Vasya_".concat(i), "Lom_".concat(i), "".concat(i, "_ddd_").concat(i, "@gmail.com"), Number(generNumber())));
    }
    return users;
}
var usersNew = [];
var users2 = makeUsersObj(usersNew);
console.log(users2);
/*
...
*/
function Car5(id, model, producer, year, speed, volume) {
    this.id = id;
    this.model = model;
...
var car1 = new Car5(1, 'Megane', 'Renault', 1999, 200, '2.0');
...
console.log(popelushechki.filterCustom(function (elem) { return elem.age > 38; }));
...
var newPopelArr = popelushechki.mapCustom(function (elem) {
    return __assign(__assign({}, elem), { age: elem.age * 2 });
});
