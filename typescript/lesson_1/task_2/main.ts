...
*/
let arr: (string | number | boolean | object)[] = [1, 2, 3, 55, 66, 'renault', true, false, {name: 'Vasya', age: 100}, ['salary', 'page', true]];
console.log(arr[0]);
console.log(arr[1]);
console.log(arr[2]);
console.log(arr[3]);
...
*/
let bookOne: {title: string, pageCount: number, genre: string, authors: {name: string, age}[]} = {
    title: 'Kobzar',
    pageCount: 300,
    genre: 'poeziya',
    authors: [{name: 'Shevchenko', age: 33}]
}
let bookTow: {title: string, pageCount: number, genre: string, authors: {name: string, age}[]} = {
    title: 'No name',
    pageCount: 500,
    genre: 'komedi',
    authors: [{name: 'Poroh', age: 53}]
}
let bookThree: {title: string, pageCount: number, genre: string, authors: {name: string, age}[]} = {
    title: 'Kolobok',
    pageCount: 100,
    genre: 'drama',
...
*/
let arr2: {name: string, username: string, password: string}[] = [
    {
        name: 'Kolya',
        username: 'Kolya',
        password: '123frtd('
...
// або
let arr4: {morning: number, day: number, night: number}[] = [
    {
        morning: 22,
        day: 33,
        night: 22
